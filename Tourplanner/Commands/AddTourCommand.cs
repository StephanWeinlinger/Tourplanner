...
namespace Tourplanner.Client.Commands {
	public class AddTourCommand : CommandBase {
		...
		public override void Execute(object parameter) {
			...
			CombinedTour newTour = Task.Run<CombinedTour>(async () => await tourController.InsertTour(new Tour(_modifyTourViewModel.Title, _modifyTourViewModel.Description, _modifyTourViewModel.From, _modifyTourViewModel.To, _modifyTourViewModel.TransportType))).Result;
